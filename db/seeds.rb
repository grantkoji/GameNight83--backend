...
Photo.create!(likes: rand(0..100), game_id: game2.id, user_id: User.all.sample.id, caption: "Long distance Kam Jam. Should've joined the Ultimate Frisbee team", image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTATW0JSM4M_NHqCdq61ooigAVZgUabGX0KQA&usqp=CAU")
...
Photo.create!(likes: rand(0..100), game_id: game3.id, user_id: User.all.sample.id, caption: "I was hosed. Gave the point to Black. Going to appeal to the 9 year old judge.", image_url: "https://i.ytimg.com/vi/D7oKgWCopUw/maxresdefault.jpg")
...
Photo.create!(likes: rand(0..100), game_id: game4.id, user_id: User.all.sample.id, caption: "Hide your kids, hide your wife from THE BIG SPIKE!", image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcR-l_7E_J3gP8SHiR6iEIurmrEXs7l0wru_vg&usqp=CAU")
...
Photo.create!(likes: rand(0..100), game_id: game5.id, user_id: User.all.sample.id, caption: "Had to deduct a point for the illegal toss", image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTpRvscsMJ4M5Xcmd0zriNSs34LLIG5t28yAA&usqp=CAU")
...
Photo.create!(likes: rand(0..100), game_id: game6.id, user_id: User.all.sample.id, caption: "Neither of them wound up with the ball", image_url: "https://i.pinimg.com/originals/5f/c6/7e/5fc67e55b2900aa1267e623a7817129c.jpg")

game7 = Game.create!(title: "Wooden Lawn Bowling Set", creator_id: User.all.sample.id, min_age: 7, min_num_players: 2, max_num_players: 12, image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRZlnhEcVJ6HvpUmqveetUBZ6zHGCdGZUqfB7n9pMYINNo7HA0ASExREjHufYg&usqp=CAc", 
