...
this_user = User.create!(username: "Catanimal", name: "Grant", password: "1234", age: 75, fav_games: "Catan, Codenames, KanJam, Quiplash", profile_url: "https://i.imgur.com/pTaDCul.jpg")
...
GamePhoto.create!(likes: rand(0..100), game_id: game11.id, user_id: this_user.id, caption: "Forgot my European sandwich names...", image_url: "https://kilowatt.beer/wp-content/uploads/2019/10/zoom-trivia-845x321.jpg")
...
GamePhoto.create!(likes: rand(0..100), game_id: game17.id, user_id: this_user.id, caption: "Losing our focus, but we got this!", image_url: "https://i.kinja-img.com/gawker-media/image/upload/c_fill,f_auto,fl_progressive,g_center,h_675,pg_1,q_80,w_1200/jjfi1r0p7bnzpn24li1z.jpg")
