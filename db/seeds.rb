...
april_user = User.create!(username: "JanetS", name: "April", password: "1234", age: 35, fav_games: "Who cares?", profile_url: "https://i.pinimg.com/originals/14/bb/a6/14bba6943d2a1a628a89b304b529a723.png")
...
Friendship.create!(user_id: this_user.id, friend_id: vic_user.id)
...
GamePhoto.create!(likes: rand(0..100), game_id: game6.id, user_id: User.all.sample.id, caption: "Defying gravity", image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTrETzRXBHcQrfF5gUVvj1frn_nBbMrFHgPBA&usqp=CAU")
...
GamePhoto.create!(likes: rand(0..100), game_id: game8.id, user_id: this_user.id, caption: "Went to the beach...so he can play Bingo", image_url: "https://static8.depositphotos.com/1370441/975/i/450/depositphotos_9758096-Young-Attractive-Man-Celebrating-Success-Working-on-Computer-at.jpg")
...
GamePhoto.create!(likes: rand(0..100), game_id: game11.id, user_id: chase_user.id, caption: "Forgot my European sandwich names...", image_url: "https://kilowatt.beer/wp-content/uploads/2019/10/zoom-trivia-845x321.jpg")
...
GamePhoto.create!(likes: rand(0..100), game_id: game13.id, user_id: chase_user.id, caption: "Jeff refuses to turn around to start his turn! Meanwhile, Rachel's just holding her phone...", image_url: "https://i.insider.com/5ea30c63a34b3c67b324de14?width=1100&format=jpeg&auto=webp")
...
GamePhoto.create!(likes: rand(0..100), game_id: game14.id, user_id: chase_user.id, caption: "It was high five. How did they not get high five!?!?!", image_url: "https://imgix.bustle.com/uploads/getty/2020/3/27/ed8cc558-7510-49c4-a5d9-c5e06dda90df-getty-1214101407.jpg?w=1200&h=630&q=70&fit=crop&crop=faces&fm=jpg")
...
game22 = Game.create!(title: "Jackbox.tv: Quiplash, Drawful 2, Fibbage, and much more!", creator_id: User.all.sample.id, min_age: 12, min_num_players: 3, max_num_players: 8, image_url: "https://www.insidehook.com/wp-content/uploads/2020/05/Jackbox-Games-Logo.jpg?fit=1500%2C1000",
...
GamePhoto.create!(likes: rand(0..100), game_id: game22.id, user_id: User.all.sample.id, caption: "Dylon, Dylon, Dylon, Dylon, Dylon...Cause I spit HOT FIRE!", image_url: "https://cdn.vox-cdn.com/thumbor/zFIqmRBXi-XxQRGSX8Nn78dt_DU=/1400x788/filters:format(jpeg)/cdn.vox-cdn.com/uploads/chorus_asset/file/11685655/PLY_JAX_Template.00_09_02_43.Still001.jpg")
...
ScheduledGame.create(host_id: User.all.sample.id, game_id: Game.all.sample.id, privacy: 'Public', num_vacancies: rand(1..3), 
initial_vacant_spots: 5, status: 'scheduled', private_directions: "Email: #{Faker::Internet.email}", public_description: 'Looking for experienced players only', unix: 1597864609)

ScheduledGame.create(host_id: User.all.sample.id, game_id: Game.all.sample.id, privacy: 'Public', num_vacancies: rand(1..3), 
initial_vacant_spots: 5, status: 'scheduled', private_directions: "Email: #{Faker::Internet.email}", public_description: 'Low key environment', unix: 1597865609)

ScheduledGame.create(host_id: User.all.sample.id, game_id: Game.all.sample.id, privacy: 'Public', num_vacancies: rand(1..3), 
initial_vacant_spots: 5, status: 'scheduled', private_directions: "Email: #{Faker::Internet.email}", public_description: 'Any welcome, be careful, we have some gamers', unix: 1597866609)
...
initial_vacant_spots: 5, status: 'scheduled', private_directions: "Email: #{Faker::Internet.email}", public_description: 'This game is brought to you by the S Lounge', unix: 1598063609)

ScheduledGame.create(host_id: User.all.sample.id, game_id: Game.all.sample.id, privacy: 'Public', num_vacancies: rand(1..3), 
initial_vacant_spots: 5, status: 'scheduled', private_directions: "Email: #{Faker::Internet.email}", public_description: 'This is literally the best game in the world', unix: 1598162609)

ScheduledGame.create(host_id: User.all.sample.id, game_id: Game.all.sample.id, privacy: 'Public', num_vacancies: rand(1..3), 
initial_vacant_spots: 5, status: 'scheduled', private_directions: "Email: #{Faker::Internet.email}", public_description: 'Open to all', unix: 1598168809)

ScheduledGame.create(host_id: User.all.sample.id, game_id: game22.id, privacy: 'Public', num_vacancies: rand(1..3), 
initial_vacant_spots: 5, status: 'scheduled', private_directions: "Email: #{Faker::Internet.email}", public_description: "Be ready for the Last Lash!", unix: 1597867181)
...
ScheduledGame.create(host_id: User.all.sample.id, game_id: Game.all.sample.id, privacy: 'Public', num_vacancies: rand(1..3), 
initial_vacant_spots: 5, status: 'scheduled', private_directions: "Email: #{Faker::Internet.email}", public_description: "Looking forward to meeting you", unix: 1597863669)

ScheduledGame.create(host_id: User.all.sample.id, game_id: Game.all.sample.id, privacy: 'Public', num_vacancies: rand(1..3), 
initial_vacant_spots: 5, status: 'scheduled', private_directions: "Email: #{Faker::Internet.email}", public_description: "Looking at you, Bert Macklin FBI", unix: 1597863760)
